package my.Checkers.core;

import java.util.ArrayList;

/**
 * This class is responsible for the methods connected with the pieces of the board
 */
...
public class Pawn {
    ...
    //This method returns the Position array that returns all position of the Pawn where he can do a step
    ...
    //  returns all positions where the pawn can do eat action
    ...
    // returns all positions where king can do a step
    ...
    //  returns all positions where the king can do eat action
